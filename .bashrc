...
#export GREP_OPTIONS='--color=auto' #TODO: Depriecated, look to replace
...
function __setprompt
{
	...
	if [[ $LAST_COMMAND != 0 ]]; then
		...
		PS1="\[${GRAY}\](\[${LIGHTRED}\]ERROR\[${GRAY}\])-(\[${RED}\]Exit Code \[${LIGHTRED}\]${LAST_COMMAND}\[${GRAY}\])-(\[${RED}\]"
	...
	# Date
	PS1+="\[${LIGHTGRAY}\](\[${CYAN}\]\$(date +%a) $(date +%b' '%d)" # Date
